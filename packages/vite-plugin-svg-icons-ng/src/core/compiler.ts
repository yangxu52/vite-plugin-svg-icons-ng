...
function resolveSymbolIdConflicts(icons: CompiledIcon[], ctx: CompilerContext): CompiledIcon[] {
  const seen = new Map<string, CompiledIcon>()
  const resolved: CompiledIcon[] = []
